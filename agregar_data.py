...
cuenta2 = CuentasAhorro(numero_cuenta="CA56789", nombre_titular="María Gómez", saldo_actual=300, fecha_apertura=datetime.date(year=2023, month=12, day=2))
cuenta3 = CuentasAhorro(numero_cuenta="CA01257", nombre_titular="Genny Alcivar", saldo_actual=650, fecha_apertura=datetime.date(year=2022, month=5, day=7))
cuenta4 = CuentasAhorro(numero_cuenta="CA06036", nombre_titular="Aníbal Sánchez", saldo_actual=740, fecha_apertura=datetime.date(year=2021, month=11, day=12))
cuenta5 = CuentasAhorro(numero_cuenta="CA54377", nombre_titular="Rosa Guzmán", saldo_actual=1250, fecha_apertura=datetime.date(year=2000, month=8, day=7))
